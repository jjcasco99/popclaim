  ...
  return (
    <header className="headerContainer">
      ...
      <div className="informs">
        <h3>
          <img src={list} alt="" /> INFORMES
        </h3>
        <div className="opciones-informe">
          <ul>
            <li className="informes-hover">
              <Link to="/informe">Nuevo informe</Link>
            </li>
            <li className="informes-hover">Historial de informes</li>
          </ul>
        </div>
      </div>
      ...
      <div className="user-profile">
        <h3>
          <img src={user} alt="" /> PERFIL USUARIO
        </h3>
      </div>

      <div className="options">
        <h3 onClick={() => logout({ returnTo: window.location.origin })}>
          <img src={gear} alt="" /> CERRAR SESIÓN
        </h3>
      </div>
    </header>
  );
